...
Root: HKCU; Subkey: "Software\Kortexa AI\Sideleaf\Capabilities\FileAssociations"; ValueType: string; ValueName: ".txt"; ValueData: "Sideleaf.Text"
...
Root: HKCU; Subkey: "Software\Classes\Sideleaf.Text"; ValueType: string; ValueData: "Text document"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\Classes\Sideleaf.Text"; ValueType: string; ValueName: "FriendlyTypeName"; ValueData: "Text document"
Root: HKCU; Subkey: "Software\Classes\Sideleaf.Text\DefaultIcon"; ValueType: string; ValueData: "{app}\bin\launcher.exe,0"
Root: HKCU; Subkey: "Software\Classes\Sideleaf.Text\shell\open\command"; ValueType: string; ValueData: """{app}\bin\launcher.exe"" --sideleaf-open ""%1"""
Root: HKCU; Subkey: "Software\Classes\.txt\OpenWithProgids"; ValueType: string; ValueName: "Sideleaf.Text"; ValueData: ""; Flags: uninsdeletevalue
